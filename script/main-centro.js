...
(async ()=>{
    ...
    while (reiniciar) {
        try {
            ...
            // Aguarde um período de tempo antes de reiniciar (opcional)
...
//             // Simulação de um erro (substitua isso pelo seu código real)
//             throw new Error("Erro simulado");

//             // Se o código chegou até aqui sem lançar um erro, significa que foi executado com sucesso
//             reiniciar = false; // Definindo reiniciar como falso para sair do loop
//         } catch (error) {
//             console.error("Ocorreu um erro:", error);
//             console.log("Reiniciando...");
